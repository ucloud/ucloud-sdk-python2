...
class UCloudStackClient(Client):
    ...
    def attach_nic(self, req=None, **kwargs):
    ...
    def create_nic(self, req=None, **kwargs):
        """CreateNIC - 创建网卡
    ...
    def delete_nic(self, req=None, **kwargs):
        """DeleteNIC - 删除网卡
    ...
    def describe_nic(self, req=None, **kwargs):
        """DescribeNIC - 获取网卡信息
    ...
    def describe_security_group_resource(self, req=None, **kwargs):
    ...
    def describe_snapshot(self, req=None, **kwargs):
    ...
    def detach_nic(self, req=None, **kwargs):
