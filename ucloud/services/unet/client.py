...
class UNetClient(Client):
    ...
    def describe_vip(self, req=None, **kwargs):
    ...
    def release_vip(self, req=None, **kwargs):
        """ ReleaseVIP - 释放VIP资源
    ...
    def update_eip_attribute(self, req=None, **kwargs):
    ...
    def __getattr__(self, item):
        if item in self._deprecated:
            ...
            msg = "the method {} is deprecated, please use {} instead, this method will remove after 0.5.0 version"
