...
class HTTPStatusException(TransportException):
    def __init__(self, status_code, request_uuid=None):
...
class InvalidResponseException(TransportException):
    def __init__(self, content, message, request_uuid=None):
...
class RetCodeException(UCloudException):
    def __init__(self, action, code, message, request_uuid=None):
        self.action = action
        self.code = code
        self.message = message
        self.request_uuid = request_uuid
